            ...
            <section class="px-4 py-24 mx-auto max-w-7xl">
                <div class="grid items-center w-full grid-cols-1 gap-10 mx-auto md:w-4/5 lg:grid-cols-2 xl:gap-32">
                    <div>
                        ...
                        <a href="/d" class="w-full mb-2 btn btn-lg btn-light sm:w-auto sm:mb-0">Back to homepage</a>
                        <a href="/users" class="w-full mb-2 btn btn-lg btn-white sm:w-auto sm:mb-0">Contact us</a>
                    </div>
                    <div>
